...
// Calculate puzzle password
const largestCircuitsSize = circuits.map(c => c.size).sort((a, b) => b - a)
const password = largestCircuitsSize.slice(0, 3).reduce((acc, s) => acc * s, 1)
